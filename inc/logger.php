 ...
 * Simple logger class.
 *
 * SOURCE - https://github.com/Idearia/php-logger
 * 
...
class Logger {
     ...
     */
    public static $log_file_name = "extrafood";
    ...
    public static function init() {
        ...
        if ( ! self::$logger_ready ) {
            ...
            if ( file_exists( self::$log_dir ) ) {
                self::$log_file_path = implode( DIRECTORY_SEPARATOR, [ self::$log_dir, self::$log_file_name.date('-Y-m') ] );
